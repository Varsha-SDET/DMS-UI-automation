...
/*
 *@className - QAFinalApprovalTest
 *@Objective - To define all the test cases for QA final Approval stage.
 */
public class QAFinalApprovalTest extends TestUtils {
    @DataProvider
    ...
    public void verifyRequestChangesActivity(HashMap<String, String> input) throws InterruptedException {
        ...
        String text =qaFinalStage.requestChangesActivitySelection();
        Assert.assertTrue(text.contains("Transaction Completed successfully"));
